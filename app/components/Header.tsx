...
import { MdOutlineShoppingBag, MdFavoriteBorder, MdPersonOutline, MdMenu, MdClose, MdSearch, MdKeyboardArrowDown } from 'react-icons/md';
...
const Header = ({ initialCategories = [], dir }: HeaderProps) => {
    ...
    return (
        <>
            {/* Spacer to prevent layout shift when header collapses. Matches exact expanded heights: Mobile: 140px, Tablet: 126px, Desktop: 158px */}
            <div className="w-full h-[140px] md:h-[126px] lg:h-[158px]" aria-hidden="true" />

            <header className="fixed top-0 left-0 z-50 w-full bg-white dark:bg-surface-dark border-b border-[#f4f0f2] dark:border-white/10 transition-all duration-300">
                        ...
                        <div className="flex items-center shrink-0">
                            ...
                            <div className={`transition-all duration-500 ease-in-out ${isScrolled ? 'ms-2' : 'ms-0'}`}>
                                <Link href="/" className="flex flex-col items-center">
                                    <span className="text-[28px] leading-none font-semibold tracking-tight text-[rgb(46,46,46)] dark:text-white">
                                        Ruby Beauty
                                    </span>
                                    <span className={`font-medium leading-none transition-all duration-300 ${dir === 'rtl'
                                        ? 'text-[13px] tracking-normal mt-[2px] font-semibold text-[rgb(46,46,46)] dark:text-white'
                                        : 'text-[10px] tracking-[0.2em] uppercase mt-[2px] text-[rgb(46,46,46)] dark:text-white/70'
                                        }`}>
                    ...
                    <div className="flex md:hidden flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Link href="/" className="flex flex-col items-center">
                                    <span className="text-[19.6px] leading-none font-semibold tracking-tight text-[rgb(46,46,46)] dark:text-white uppercase">
                                        Ruby Beauty
                                    </span>
                                    <span className={`font-medium leading-none transition-all duration-300 ${dir === 'rtl'
                                        ? 'text-[11px] tracking-normal mt-[4px] font-semibold text-[rgb(46,46,46)] dark:text-white'
                                        : 'text-[9px] tracking-[0.1em] uppercase mt-[4px] text-[rgb(46,46,46)] dark:text-white/70'
                                        }`}>
                                        {dir === 'rtl' ? 'جـمــالــك يـلـيــق بــك' : 'Your beauty deserves it'}
                                    </span>
                                </Link>
                            ...
                            {navData.map((mc) => (
                                ...
                                >
                                    <Link
                                        ...
                                        className={`text-[15px] font-semibold relative flex items-center gap-1 after:content-[''] after:absolute after:bottom-[-2px] after:right-0 after:w-full after:h-[1px] after:bg-current after:transition-transform after:duration-300 after:origin-left hover:after:origin-right transition-colors ${
