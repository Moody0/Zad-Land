    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="bg-white dark:bg-zinc-900 p-6 md:p-8 rounded-2xl border border-gray-200 dark:border-white/10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="col-span-1">
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-gray-50 dark:bg-zinc-800/60 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-zinc-900 dark:text-white focus:border-zinc-900 dark:focus:border-white focus:ring-1 focus:ring-zinc-900 dark:focus:ring-white outline-none transition-all placeholder:text-gray-400"
                        ...
                        <input
                            ...
                            className={`w-full bg-gray-50 dark:bg-zinc-800/60 border rounded-xl px-4 py-3 text-sm text-zinc-900 dark:text-white outline-none transition-all placeholder:text-gray-400 ${
                                formData.phone && !/^09\d{8}$/.test(formData.phone)
                                    ...
                                    : 'border-gray-200 dark:border-white/10 focus:border-zinc-900 dark:focus:border-white focus:ring-1 focus:ring-zinc-900 dark:focus:ring-white'
                            }`}
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <select
                            ...
                            required
                            className="w-full bg-gray-50 dark:bg-zinc-800/60 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-zinc-900 dark:text-white focus:border-zinc-900 dark:focus:border-white focus:ring-1 focus:ring-zinc-900 dark:focus:ring-white outline-none transition-all appearance-none cursor-pointer"
                        >
                ...
                <div className="mt-6 pt-5 border-t border-gray-200 dark:border-white/10">
                    <div className="flex items-center gap-3 p-3.5 bg-gray-50 dark:bg-zinc-800/60 rounded-xl border border-gray-200 dark:border-white/10">
                        <MdInfo className="text-zinc-900 dark:text-white text-lg shrink-0" />
            ...
            <div className="flex items-center justify-between mt-2 px-1">
                <Link className="flex items-center gap-2 text-xs sm:text-sm font-bold text-gray-500 hover:text-zinc-900 dark:hover:text-white transition-colors" href="/cart">
