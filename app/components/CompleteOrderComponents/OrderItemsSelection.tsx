                ...
                {items.map((item) => (
                    ...
                    >
                        <img
                            ...
                            loading="lazy"
                        />
                        <span className="absolute -top-1.5 ltr:-right-1.5 rtl:-left-1.5 bg-[#C20059] text-white text-[10px] font-extrabold w-5 h-5 flex items-center justify-center rounded-full z-10 border border-white dark:border-zinc-900 shadow-sm">
                            {item.quantity}
                        </span>
                    </div>
                ))}
